    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.students.update", [$student->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}" type="text" name="full_name" id="full_name" value="{{ old('full_name', $student->full_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_code') ? 'is-invalid' : '' }}" type="text" name="post_code" id="post_code" value="{{ old('post_code', $student->post_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_no') ? 'is-invalid' : '' }}" type="text" name="contact_no" id="contact_no" value="{{ old('contact_no', $student->contact_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ni_no') ? 'is-invalid' : '' }}" type="text" name="ni_no" id="ni_no" value="{{ old('ni_no', $student->ni_no) }}">
                @if($errors->has('ni_no'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ni_no') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_entry') ? 'is-invalid' : '' }}" type="text" name="date_of_entry" id="date_of_entry" value="{{ old('date_of_entry', $student->date_of_entry) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('referred_by') ? 'is-invalid' : '' }}" type="text" name="referred_by" id="referred_by" value="{{ old('referred_by', $student->referred_by) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('employment_status') ? 'is-invalid' : '' }}" name="employment_status" id="employment_status">
                    ...
                    @foreach(App\Models\Student::EMPLOYMENT_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('employment_status', $student->employment_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('campus') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="campus" id="campus" value="1" {{ $student->campus || old('campus', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('course_applying_for') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="course_applying_for" id="course_applying_for" value="1" {{ $student->course_applying_for || old('course_applying_for', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('course_title') ? 'is-invalid' : '' }}" type="text" name="course_title" id="course_title" value="{{ old('course_title', $student->course_title) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('course_time_table') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="course_time_table" id="course_time_table" value="1" {{ $student->course_time_table || old('course_time_table', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Student::SESSIONS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('sessions') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="sessions_{{ $key }}" name="sessions" value="{{ $key }}" {{ old('sessions', $student->sessions) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('previous_study') ? 'is-invalid' : '' }}" type="text" name="previous_study" id="previous_study" value="{{ old('previous_study', $student->previous_study) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('availibility') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="availibility" id="availibility" value="1" {{ $student->availibility || old('availibility', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('qualifications') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="qualifications" id="qualifications" value="1" {{ $student->qualifications || old('qualifications', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_contact_name') ? 'is-invalid' : '' }}" type="text" name="emergency_contact_name" id="emergency_contact_name" value="{{ old('emergency_contact_name', $student->emergency_contact_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_contact_phone') ? 'is-invalid' : '' }}" type="text" name="emergency_contact_phone" id="emergency_contact_phone" value="{{ old('emergency_contact_phone', $student->emergency_contact_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_contact_relation') ? 'is-invalid' : '' }}" type="text" name="emergency_contact_relation" id="emergency_contact_relation" value="{{ old('emergency_contact_relation', $student->emergency_contact_relation) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('references') ? 'is-invalid' : '' }}" name="references" id="references">{{ old('references', $student->references) }}</textarea>
